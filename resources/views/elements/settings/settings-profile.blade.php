...
<form method="POST" action="{{route('my.settings.profile.save',['type'=>'profile'])}}">
    ...
    <div class="form-group">
        <label for="TikTok" value="{{Auth::user()->tiktok_url}}">{{__('TikTok URL')}}</label>
        <input type="url" class="form-control {{ $errors->has('TikTok') ? 'is-invalid' : '' }}" id="TikTok" name="tiktok_url" aria-describedby="emailHelp" value="{{Auth::user()->tiktok_url}}">
    ...
    <div class="form-group">
        <label for="Instagram_url" value="{{Auth::user()->instagram_url}}">{{__('Instagram URL')}}</label>
        <input type="url" class="form-control {{ $errors->has('Instagram_url') ? 'is-invalid' : '' }}" id="Instagram" name="instagram_url" aria-describedby="emailHelp" value="{{Auth::user()->instagram_url}}">
    ...
    <div class="form-group">
        <label for="OnflyFans" value="{{Auth::user()->onlyfans_url}}">{{__('OnflyFans URL')}}</label>
        <input type="url" class="form-control {{ $errors->has('OnflyFans') ? 'is-invalid' : '' }}" id="OnflyFans" name="onlyfans_url" aria-describedby="emailHelp" value="{{Auth::user()->onlyfans_url}}">
        @if($errors->has('OnflyFans'))
            <span class="invalid-feedback" role="alert">
                <strong>{{$errors->first('OnflyFans')}}</strong>
            </span>
        @endif
    </div>
