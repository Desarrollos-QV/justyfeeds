        ...
        <div class="min-vh-100 col-12">
            <div class="container messenger min-vh-100">
                <div class="row min-vh-100">
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12 border border-right-0 border-left-0 rounded-left conversations-wrapper min-vh-100 overflow-hidden border-top ">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-xs-12 border conversation-wrapper rounded-right p-0 d-flex flex-column min-vh-100">
